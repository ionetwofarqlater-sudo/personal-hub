...
import { BookMarked, Settings, UserCircle2, Pencil, Check, EyeOff, Eye } from 'lucide-react';
    ...
    <div>
        ...
        {visibleApps.map(app => {
          ...
          if (editing) {
            return (
              ...
              >
                <div className={`w-14 h-14 bg-gradient-to-br ${app.gradient} rounded-2xl flex items-center justify-center shadow-lg ${app.glow}`}>
      ...
      {!editing && visibleApps.length === 0 && (
        <p className="text-gray-600 text-sm text-center py-8">
          Всі ярлики сховані.{' '}
          <button onClick={() => setEditing(true)} className="text-violet-400 hover:text-violet-300 underline">
            Редагувати
          </button>
        </p>
      )}
