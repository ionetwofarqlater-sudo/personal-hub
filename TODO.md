...
- [x] Визначити ролі та права доступу (мінімум: `admin`, `user`)
- [x] Додати таблицю ролей (`user_roles`) і прив'язку до `auth.users`
- [x] Захистити `admin` роут (`/dashboard/admin`) через middleware + server-side перевірку ролі
...
- [x] Додати сторінку доступу `403` для не-адмінів
